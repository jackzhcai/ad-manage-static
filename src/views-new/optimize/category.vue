<template>
  <div class="app-container">
    ...
    <el-dialog :visible.sync="dialogVisible" :title="dialogType==='edit'?'编辑直客广告投放类别':'新增直客广告投放类别'">
...
import { fetchOptimizeCategoryList } from '@/api/new/optimize'
...
export default {
  ...
  methods: {
    async getList() {
      ...
      const res = await fetchOptimizeCategoryList(this.listQuery)
