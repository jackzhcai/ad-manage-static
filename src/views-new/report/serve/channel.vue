<template>
  <div class="app-container">
    <div class="filter-container" style="display: flex; align-items: flex-start">
      <el-input v-model="listQuery.slotName" placeholder="请输入广告位" style="width: 200px; margin-right: 6px;" class="filter-item" @keyup.enter.native="handleFilter" />
      <el-date-picker
    ...
    >
      ...
      <el-table-column label="广告分布" align="center">
        <template slot-scope="scope">
...
<script>
import { fetchReportServeChannelList } from '@/api/new/article'
...
export default {
  ...
  methods: {
    setQuery() {
      ...
      this.listQuery.slotName = querys.slot_name || ''
    },
    getList() {
      this.listLoading = true
      fetchReportServeChannelList(this.listQuery).then(response => {
